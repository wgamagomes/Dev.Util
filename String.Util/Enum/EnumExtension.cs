...
namespace Dev.Util.Enum
{
    public static class EnumExtension
    {
        ...
        /// If the passed value is null and getDefault was set to true then the default value of the enumerated is returned.
        /// If not an ArgumentNullException is thrown.
        /// </summary>
        /// <typeparam name="TEnum"></typeparam>
